...
| [EXP-0009](EXP-0009-static-physical-proxy-screening.md) | In progress; toolchain commissioned, candidate pre-data | Synthesis-toolchain commissioning; planned synthesis estimate | Toy Yosys/OpenSTA/Sky130 path passes; Graph/Rocket area/timing manifest must freeze before candidate data |
