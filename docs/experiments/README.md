...
| [EXP-0009](EXP-0009-static-physical-proxy-screening.md) | In progress; recovery-v5 frozen | Synthesis-toolchain commissioning; collector compatibility probes | Named cut, library-aware integrity, and supported OpenSTA Tcl are frozen; Graph retry is next |
