...
| [EXP-0009](EXP-0009-static-physical-proxy-screening.md) | Paused; common-partition selection incomplete | Synthesis-toolchain commissioning; synthesis-collector failure | Toy flow passes, but bounded Graph attempts stop before synthesis; no candidate area/timing datum and Rocket unrun |
