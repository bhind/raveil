...
| [EXP-0009](EXP-0009-static-physical-proxy-screening.md) | In progress; recovery-v6 pre-data | Synthesis-toolchain commissioning; collector compatibility probes | Sealed Graph raw is rejected for implicit common black boxes; explicit exactly-once declarations must be frozen |
