...
| [EXP-0009](EXP-0009-static-physical-proxy-screening.md) | In progress; recovery-v5 pre-data | Synthesis-toolchain commissioning; collector compatibility probes | Named cut reaches mapping; library-aware integrity and supported OpenSTA Tcl must be frozen before Graph retry |
