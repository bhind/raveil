...
| [EXP-0009](EXP-0009-static-physical-proxy-screening.md) | In progress; Stage-B manifest frozen, candidate pre-data | Synthesis-toolchain commissioning; planned synthesis estimate | Toy Yosys/OpenSTA/Sky130 path passes; exact Graph/Rocket RTL and partition contract frozen before candidate data |
