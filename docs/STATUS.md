...
T-0192 is integrated through PR #245 as `cbba88f`; Issue #242 is closed and its
canonical Project item is Done. Garden now accepts the stage or instruction
...
Exact `d2c1186` passed 100 focused tests, 845 full tests with two skips,
independent Vreji and Tester review, the record checker and diff check. Evidence
is Host Functional only.
...
five compiler-dependent skips; Vreji reports no material concern. PR #172
merged as `ae717f9`; Issue #171 is closed and canonical Project completion
succeeded. Both
...
T-0132/S09 is canonical through PR #88, exact head `d65c480`, merge
`de55cac`, Closed Issue #87, and a Done Project item. ADR-0074 requires the existing AXI4-Lite
...
one common simulator SHA, and checks that the rejected request produced no AXI
