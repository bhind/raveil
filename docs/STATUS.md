...
T-0139 is the active software-only readiness slice under Issue #93 and branch
`feat/t-0139-kv260-readiness-preflight`. ADR-0076 adds the operator-facing
...
device inspection because the host is not Linux. Exact-head review and remote
