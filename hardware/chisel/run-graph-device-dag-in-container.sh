...
rm -rf generated_static generated_static_repeat obj_graph_device_dag \
  .bsp .scala-build
...
sha256sum obj_graph_device_dag/VStaticStencilRegion | awk '{print $1}' \
...
./obj_graph_device_dag/VStaticStencilRegion --dag "$evidence_root" \
