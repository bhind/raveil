...
cd "$build"
{
  ...
  for file in contracts/graph_device_dynamic_request_v6.json contracts/graph_device_program_v5.json contracts/graph_device_program_v6.json contracts/graph_device_dynamic_request_v7.json; do
