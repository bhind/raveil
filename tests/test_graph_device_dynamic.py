...
class GraphDeviceDynamicTests(unittest.TestCase):
    ...
    def test_cxx_admission_precedes_model_and_chisel_gates_v2_max(self):
        ...
        self.assertIn("program_version >= kVersionV2 && program_version <= 6U", parser)
        ...
        self.assertIn("payload[1] >= 2U && payload[1] <= 6U", fallback)
        ...
        for name in ("graph_device_dynamic_request_v5.json", "graph_device_dynamic_request_v6.json",
                     "graph_device_program_v5.json", "graph_device_program_v6.json",
                     "graph_device_dynamic_request_v7.json"):
