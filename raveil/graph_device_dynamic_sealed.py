...
SOURCE_PATHS = (
    ...
    "contracts/graph_device_program_v5.json", "contracts/graph_device_dynamic_request_v6.json",
    "contracts/graph_device_program_v6.json", "contracts/graph_device_dynamic_request_v7.json",
...
def _expected_runner_source_manifest(verified: dict[str, Any]) -> bytes:
    ...
    orchestration += ("contracts/graph_device_dynamic_request_v5.json",
                      ...
                      "contracts/graph_device_dynamic_request_v7.json")
